            ...
            <h3>Add new car details</h3><hr>
                <form action="add_car.php" method="post" id="fileForm" role="form">
                    ...
                    <div class="form-group">   
                        ...
                        <input class="form-control" type="text" name="vehicle_number" id = "vehicle_number" placeholder="e.g. US07 VA 9946" required />
                    </div><br>
                    <div class="form-group">   
                        <label for="title"><span class="req"></span>Model: </label>
                        <input class="form-control" type="text" name="model" id = "model" placeholder="e.g. Tesla" required />
                    </div><br>

                    <div class="form-group">   
                        <label for="date"><span class="req"></span>Seating capacity: </label>
                        <input class="form-control" type="number" min="2" max="4" name="seating_capacity" id = "seating_capacity" placeholder="2-4" required />
                    </div><br>
                    <div class="form-group">   
                        <label for="date"><span class="req"></span>Rent (per day): </label>
                        <input class="form-control" type="number" name="rent" id = "rent" placeholder="in Dollars" required />
                    </div><br>                    

...
if (isset($_POST['submit'])) {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
        ...
        $_SESSION['license_number'] = filter_var($_POST['license_number'], FILTER_SANITIZE_STRING);
        ...
        if ($result > 0) {
            ...
            $sql = "INSERT INTO customers (email, name,license_number, city,password) VALUES (:email, :name,:license_number,:city,:password)";
            //Prepare Query for Execution
            $query = $con->prepare($sql);
            // Bind the parameters
            $query->bindParam(':email', $_SESSION['email'], PDO::PARAM_STR);
            $query->bindParam(':name', $_SESSION['name'], PDO::PARAM_STR);
            $query->bindParam(':license_number', $_SESSION['license_number'], PDO::PARAM_STR);
    ...
    <div class="container">
        ...
        <div class="signup-form">
            ...
            <form action="#" method="post" id="fileForm" role="form">
                ...
                <div class="form-group">
                    <label for="license_number"><span class="req"></span> License Number: </label>
                    <input class="form-control" required type="text" name="license_number" id="license_number"
                        placeholder="AA 12 1234 1234567" />
                </div>   
                <div class="form-group">
